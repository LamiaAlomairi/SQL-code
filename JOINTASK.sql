...
SELECT artist_name, album_name FROM Artists LEFT JOIN Albums ON Albums.artist_id = Artists.artist_id;
...
SELECT album_name, artist_name FROM Artists RIGHT JOIN Albums ON Albums.artist_id = Artists.artist_id;
...
SELECT album_name, artist_name FROM Artists FULL JOIN Albums ON Albums.artist_id = Artists.artist_id;